...
#resume_item(
  "南开大学·计算机学院",
  "计算机科学与技术",
  "专业排名：21/135  GPA：3.8  核心专业课：C++、Python、算法导论、数据结构、概率论、线性代数、机器学习、深度学习、计算机视觉基础等",
  "2021.09 -- 2025.06（预计）"
)
...
#resume_desc(
  "主要实习工作",
  "前期主要是了解Diffusion相关的工作，之后开始学习CLIP模型，然后由一位博士师兄带着一起对CLIP模型进行微调"
)
...
#resume_desc(
  "感兴趣的研究方向",
  [强化学习（Policy-based）及其应用、脑科学及认知科学启发下的计算机视觉研究、物体检测等]
)
